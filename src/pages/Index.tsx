...
const Index = () => {
  ...
  // Fetch SEO data immediately on component mount
  useEffect(() => {
    const loadSEOData = async () => {
      console.log('🚀 Index: Fetching SEO data immediately...');
      const data = await getSEOData('home');
      setSeoData(data);
      setSeoDataLoaded(true);
      console.log('✅ Index: SEO data loaded:', data);
    };
  ...
  return (
    <>
      {seoDataLoaded && <SEOHead pageType="home" seoData={seoData} />}
